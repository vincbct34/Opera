...
import { SecuritySeverity, SecurityLogType } from '@/app/generated/prisma';
...
describe('Security Logger', () => {
  ...
  test('all logging functions work', async () => {
    ...
    const { SecurityLogType, SecuritySeverity } = await import('@/app/generated/prisma');
    const req = createMockRequest({});
  ...
  test('logSecurityEvent handles errors', async () => {
    ...
    const { SecurityLogType } = await import('@/app/generated/prisma');
